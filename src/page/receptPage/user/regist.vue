<template>
    <div class="add-article">
        <el-form ref="form" :model="data" :rules="rules" label-width="80px">
            ...
            <el-form-item>
                <el-button type="primary" :disabled="grade.updateUser||loading" @click="saveUser">注册</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
<script type="text/javascript">
    ...
    module.exports = {
            ...
            return {
                ...
                rules: {
                    ...
                    mobile: [{
                        ...
                        validator: (rule, value, callback) => {
                            if (!common.mobile_reg.test(value)) {
                                callback(new Error(common.mobile_txt));
            ...
            saveUser(){
                this.$refs.form.validate(v => {
                    if (v) {
                        ...
                        ajax.call(this, Action.REGISTER, this.data, (data, err) => {
                            this.loading = false;
                            if (!err) {
                                this.$message({
                                    message: '保存成功',
        ...
        mounted() {
            ...
            if(id) {
                ajax.call(this, Action.GETUSERBYID, {id}, (obj, err) => {
                    if (!err) {
