...
export default {
    ...
    web_path:'http://localhost:3000',//前台地址
    name_reg:/^[_0-9a-z]{6,16}$/, //帐号验证
    name_txt:'用户名由6-16位字母、数字或下划线组成', //帐号规则
    pass_reg:/^(?=.*?[a-zA-Z])(?=.*?[0-9])(?=.*?[\.\!\~\_@#$])[a-zA-Z0-9\.\!\~_@#$]{8,20}$/, //密码验证 字母数字+符号
    defaultPassword:'88888888888a', //默认密码：当修改用户信息时不更改密码的标识
    pass_txt:'8至20个字母数字+符号组成的字符', //密码规则
    email_reg:/^[a-z\d]+([-_.][a-z\d]+)*@([a-z\d]+[-.])+[a-z]{2,3}$/, //邮箱正则表达式
    email_txt:'请输入正确邮箱地址',
    mobile_reg:/^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|17[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$/,//手机正则表达式
    mobile_txt:'请输入正确手机',
